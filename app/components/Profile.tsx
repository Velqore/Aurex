    ...
    <div className="space-y-6">
      ...
      <div className="flex items-start space-x-6">
        <div className="relative">
          <div className="w-32 h-32 bg-cyber-blue rounded-full flex items-center justify-center text-4xl font-bold text-cyber-dark relative overflow-hidden">
            {uploadingAvatar && (
          ...
          <label
            ...
            className="absolute bottom-0 right-0 p-2 bg-cyber-gray border border-cyber-border rounded-full hover:bg-cyber-border transition-colors cursor-pointer"
          >
